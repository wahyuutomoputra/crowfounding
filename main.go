...
func main() {
	...
	api.POST("/avatars", authMiddleware(authService, userService), userHander.UploadAvatar)
...
func authMiddleware(authService auth.Service, userService user.Service) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			response := helper.APIResponse("Unathorized", http.StatusUnauthorized, "erro", nil)
			c.AbortWithStatusJSON(http.StatusUnauthorized, response)
			return
		}
